...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Supplier Affordable — Affordable Fashion in Lagos" },
      { name: "description", content: "Curated women's and men's fashion in Lagos, Nigeria. Shop our collection online." },
      { property: "og:title", content: "Supplier Affordable — Affordable Fashion in Lagos" },
      ...
      { name: "twitter:title", content: "Supplier Affordable — Affordable Fashion in Lagos" },
