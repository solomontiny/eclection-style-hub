...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SupplierAffordable — Affordable Fashion in Lagos" },
      { name: "description", content: "Curated women's and men's fashion in Lagos, Nigeria. Shop our collection online." },
      { property: "og:title", content: "SupplierAffordable — Affordable Fashion in Lagos" },
      { property: "og:description", content: "Curated women's and men's fashion in Lagos, Nigeria. Shop our collection online." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SupplierAffordable — Affordable Fashion in Lagos" },
      { name: "twitter:description", content: "Curated women's and men's fashion in Lagos, Nigeria. Shop our collection online." },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('sa_theme');if(!t){t=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';}if(t==='dark'){document.documentElement.classList.add('dark');}document.documentElement.style.colorScheme=t;}catch(e){}})();`,
          }}
        />
      </head>
      <body>
