...
function Shop() {
  ...
  const filtered = useMemo(() => {
    ...
    return result.sort((a, b) => sort === "name" ? a.name.localeCompare(b.name) : sort === "price-low" ? Number(a.sale_price ?? a.price) - Number(a.sale_price ?? b.price) : sort === "price-high" ? Number(b.sale_price ?? b.price) - Number(a.sale_price ?? b.price) : 0);
